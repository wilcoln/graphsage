...
###########################################################
# GraphSAINT source code from pytorch 
# Source: https://pytorch-geometric.readthedocs.io/en/latest/_modules/torch_geometric/loader/graph_saint.html#GraphSAINTSampler
###########################################################
